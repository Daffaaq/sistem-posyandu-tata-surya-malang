...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pemeriksaan_orang_tuas', function (Blueprint $table) {
            ...
            $table->string('tekanan_darah_ayah')->nullable();
            $table->string('tekanan_darah_ibu')->nullable();
            ...
            $table->date('tanggal_pemeriksaan_ayah')->nullable();
            $table->date('tanggal_pemeriksaan_ibu')->nullable();
            $table->date('tanggal_pemeriksaan_lanjutan_ayah')->nullable();
            $table->date('tanggal_pemeriksaan_lanjutan_ibu')->nullable();
            $table->timestamps();
        });
    }
