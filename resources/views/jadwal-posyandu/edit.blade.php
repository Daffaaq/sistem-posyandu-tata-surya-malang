                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('jadwal-posyandu.create') }}"
                            class="{{ request()->routeIs('jadwal-posyandu.create') ? 'active' : '' }}">Create Jadwal Posyandu</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Jadwal Posyandu</li>
                </ol>
            </div>
            <div class="card-body">
                <!-- Jadwal Posyandu Edit Form -->
                <form method="POST" action="{{ route('jadwal-posyandu.update', $jadwalPosyandu->id) }}">
                    @csrf
                    @method('PUT') <!-- Ensure the request uses the PUT method for updating -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kegiatan" id="nama_kegiatan"
                            ...
                            value="{{ old('nama_kegiatan', $jadwalPosyandu->nama_kegiatan) }}">
                        @error('nama_kegiatan')
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_kegiatan" id="tanggal_kegiatan"
                            ...
                            value="{{ old('tanggal_kegiatan', $jadwalPosyandu->tanggal_kegiatan) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" name="waktu_kegiatan" id="waktu_kegiatan"
                            ...
                            value="{{ old('waktu_kegiatan', $jadwalPosyandu->waktu_kegiatan) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tempat_kegiatan" id="tempat_kegiatan"
                            ...
                            value="{{ old('tempat_kegiatan', $jadwalPosyandu->tempat_kegiatan) }}">
