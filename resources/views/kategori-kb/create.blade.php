                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('kategori-kb.create') }}"
                            class="{{ request()->routeIs('kategori-kb.create') ? 'active' : '' }}">
                            Create Kategori Keluarga Berencana
                        </a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                <!-- Kategori Keluarga Berencana Create Form -->
                <form method="POST" action="{{ route('kategori-kb.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kategori_keluarga_berencana" id="nama_kategori_keluarga_berencana"
                            ...
                            value="{{ old('nama_kategori_keluarga_berencana') }}">
