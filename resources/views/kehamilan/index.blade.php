        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('kehamilan.create') }}"
                        class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                        <i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data Kehamilan
                    </a>
                </div>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = `/pregnant-management/kehamilan/${id}`;
                    $.ajax({
                        url: url,
                        type: 'DELETE',
                        data: {
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#KehamilanTable').DataTable().ajax.reload();
                            } else {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Gagal!',
