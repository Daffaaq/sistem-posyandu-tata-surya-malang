...
@section('content')
    <div class="container-fluid">
        <div class="card shadow mb-4">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('keluarga-berencana.create') }}"
                            class="{{ request()->routeIs('keluarga-berencana.create') ? 'active' : '' }}">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('keluarga-berencana.store') }}">
                    @csrf
                        ...
                        <select name="kategori_keluarga_berencana_id" id="kategori_keluarga_berencana_id"
                            ...
                            @foreach ($kategoriKeluargaBerencana as $kategori)
                                <option value="{{ $kategori->id }}"
                                    {{ old('kategori_keluarga_berencana_id') == $kategori->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input @error('is_permanent') is-invalid @enderror" type="radio"
                                ...
                                {{ old('is_permanent') == '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_permanent_yes">
                                Ya, Permanen
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input @error('is_permanent') is-invalid @enderror" type="radio"
                                ...
                                {{ old('is_permanent') == '0' ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_permanent_no">
                                Tidak Permanen
                            </label>
                        </div>
                        @error('is_permanent')
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_mulai_keluarga_berencana" id="tanggal_mulai_keluarga_berencana"
                            ...
                            value="{{ old('tanggal_mulai_keluarga_berencana') }}">
                    ...
                    <div class="form-group" id="tanggal-selesai-group">
                        ...
                        <input type="date" name="tanggal_selesai_keluarga_berencana"
                            ...
                            value="{{ old('tanggal_selesai_keluarga_berencana') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="catatan_keluarga_berencana" id="catatan_keluarga_berencana"
                            class="form-control @error('catatan_keluarga_berencana') is-invalid @enderror" placeholder="Tulis catatan...">{{ old('catatan_keluarga_berencana') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_active" id="is_active"
                            ...
                            <option value="Non-Active" {{ old('is_active') == 'Non-Active' ? 'selected' : '' }}>Non-Active
                            </option>
                        </select>
                        @error('is_active')
                            <div class="invalid-feedback">{{ $message }}</div>
