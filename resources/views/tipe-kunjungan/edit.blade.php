        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Tipe Kunjungan</li>
                </ol>
            </div>
            <div class="card-body">
                <!-- Tipe Kunjungan Edit Form -->
                <form method="POST" action="{{ route('tipe-kunjungan.update', $tipekunjungan->id) }}">
                    @csrf
                    @method('PUT') <!-- Make sure to use PUT method for update -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_tipe_kunjungan" id="nama_tipe_kunjungan"
                            ...
                            value="{{ old('nama_tipe_kunjungan', $tipekunjungan->nama_tipe_kunjungan) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                            placeholder="Tulis deskripsi disini...">{{ old('deskripsi', $tipekunjungan->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
